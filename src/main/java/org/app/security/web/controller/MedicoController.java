...
import org.app.security.service.MedicoService;
import org.app.security.service.UsuarioService;
...
public class MedicoController {
	...
	/*
	 * @PostMapping({"/salvar/ajax"}) public String salvarAjax(@RequestBody
	 * MedicoDto medicoDto, RedirectAttributes attr, @AuthenticationPrincipal User
	 * user) { medicoDto.getNome(); //service.salvar(medico);
	 * attr.addFlashAttribute("sucesso", "Operação realizada com sucesso.");
	 * //attr.addFlashAttribute("medico", medico); return "redirect:/medicos/dados";
	 * }
	 */
